...
public class InternalExternalTripTables
{
    ...
    public InternalExternalTripTables(HashMap<String, String> rbMap)
    {
    ...
    public void createTripTables(MatrixType mt)
    {
        ...
        String tripFile = Util.getStringValueFromPropertyMap(rbMap,
                "internalExternal.trip.output.file");
    ...
    public static void main(String[] args)
    {
        ...
        InternalExternalTripTables tripTables = new InternalExternalTripTables(pMap);
