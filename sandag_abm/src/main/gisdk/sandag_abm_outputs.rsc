...
Macro "ExportHwyloadtoCSV"(input_file_base, output_file_base)
  ...
  for t = 1 to tod_periods.length do
	  ...
	  ExportView(view+"|", "CSV", output_file_base+tod+".csv",
			...
			"AB_Flow_SOV_GP_HIGH",
			"BA_Flow_SOV_GP_HIGH",
			"AB_Flow_SOV_PAY_HIGH",
			"BA_Flow_SOV_PAY_HIGH",
			"AB_Flow_SR2_GP_HIGH",
			"BA_Flow_SR2_GP_HIGH",
			"AB_Flow_SR2_HOV_HIGH",
			"BA_Flow_SR2_HOV_HIGH",
			"AB_Flow_SR2_PAY_HIGH",
			"BA_Flow_SR2_PAY_HIGH",
			"AB_Flow_SR3_GP_HIGH",
			"BA_Flow_SR3_GP_HIGH",
			"AB_Flow_SR3_HOV_HIGH",
			"BA_Flow_SR3_HOV_HIGH",
			"AB_Flow_SR3_PAY_HIGH",
			"BA_Flow_SR3_PAY_HIGH",
			"AB_Flow_lhdn",
			"BA_Flow_lhdn",
			"AB_Flow_mhdn",
			"BA_Flow_mhdn",
