...
rem start remote worker nodes: SANDAG04
set PROGRAMSTRING=%PATH_NO_DRIVE%\bin\runSandag04.cmd %MAPDRIVE% %PATH_NO_DRIVE%
start %PATH_NO_DRIVE%\bin\psExec \\%NODE3% -s -c -f %PATH_NO_DRIVE%\bin\%MAPANDRUN% %MAPDRIVE% %MAPDRIVEFOLDER% %PASSWORD% %USERNAME% %PATH_NO_DRIVE% %PROGRAMSTRING%
goto :end
