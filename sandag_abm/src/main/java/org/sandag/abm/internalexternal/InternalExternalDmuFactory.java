 ...
 */
public class InternalExternalDmuFactory
        implements InternalExternalDmuFactoryIf, Serializable
{

    private InternalExternalModelStructure internalExternalModelStructure;

    public InternalExternalDmuFactory(InternalExternalModelStructure modelStructure)
    {
    ...
    {
        return new InternalExternalTourDestChoiceDMU(internalExternalModelStructure);
    }
