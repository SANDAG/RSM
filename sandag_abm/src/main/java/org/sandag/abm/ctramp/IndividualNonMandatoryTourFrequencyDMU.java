...
public class IndividualNonMandatoryTourFrequencyDMU
        implements Serializable, VariableTable
{
    ...
    protected double                   shopAccessibility;
    protected double                   maintAccessibility;
    protected double                   eatOutAccessibility;
    protected double                   visitAccessibility;
    protected double                   discrAccessibility;
    protected double                   nmDcLogsum;
    protected double                   workAccessibility;
    protected double                   schoolAccessibility;

    public String                      TOUR_FREQ_ALTERNATIVES_FILE_ESCORT_NAME   = "Escort";
    public String                      TOUR_FREQ_ALTERNATIVES_FILE_SHOPPING_NAME = "Shopping";
    public String                      TOUR_FREQ_ALTERNATIVES_FILE_MAINT_NAME    = "Maint";
    public String                      TOUR_FREQ_ALTERNATIVES_FILE_EAT_OUT_NAME  = "EatOut";
    public String                      TOUR_FREQ_ALTERNATIVES_FILE_VISIT_NAME    = "Visit";
    public String                      TOUR_FREQ_ALTERNATIVES_FILE_DISCR_NAME    = "Discr";
    ...
    public int getPersonIsNonworker()
    {
        return person.getPersonIsNonWorkingAdultUnder65()
                + person.getPersonIsNonWorkingAdultOver65();
    }
    ...
    public int getUniversityStudents()
    {
        ...
        // get the count of persons of type: university student; if more than 3,
        // return 3.
        int count = 0;
        for (int i = 1; i < p.length; i++)
        {
    ...
    public int getNonWorkers()
    {
        ...
        for (int i = 1; i < p.length; i++)
        {
            count += p[i].getPersonIsNonWorkingAdultUnder65()
                    + p[i].getPersonIsNonWorkingAdultOver65();
            if (count == 3) break;
        }
    ...
    public void setShopAccessibility(double accessibility)
    {
        shopAccessibility = accessibility;
    }

    public void setMaintAccessibility(double accessibility)
    {
        maintAccessibility = accessibility;
    }

    public void setEatOutAccessibility(double accessibility)
    {
        eatOutAccessibility = accessibility;
    }

    public void setVisitAccessibility(double accessibility)
    {
        visitAccessibility = accessibility;
    }

    public void setDiscrAccessibility(double accessibility)
    {
        discrAccessibility = accessibility;
    }

    public void setNmDcLogsum(double logsum)
    {
        nmDcLogsum = logsum;
    }

    public void setWorkAccessibility(double accessibility)
    {
        workAccessibility = accessibility;
    }

    public void setSchoolAccessibility(double accessibility)
    {
        schoolAccessibility = accessibility;
    }
    ...
    private int getOverlap(Person dmuPerson, Person otherPerson)
    {
        ...
        {
            if (dmuWindow[i] == 0 && otherWindow[i] == 0) overlap++;
        }
    ...
    public int getPreDrivingAtHome()
    {
        ...
        for (int i = 1; i < persons.length; i++)
        {
            if (persons[i].getPersonIsStudentNonDriving() == 1
                    && persons[i].getCdapActivity().equalsIgnoreCase(ModelStructure.HOME_PATTERN))
                num++;
        }
        return num;
    }
    ...
    public double getShopAccessibility()
    {
        return shopAccessibility;
    }

    public double getMaintAccessibility()
    {
        return maintAccessibility;
    }

    public double getEatOutAccessibility()
    {
        return eatOutAccessibility;
    }

    public double getVisitAccessibility()
    {
        return visitAccessibility;
    }

    public double getDiscrAccessibility()
    {
        return discrAccessibility;
    }

    public int getCdapIndex()
    {
        return person.getCdapIndex();
    }

    public double getNonMotorizedDcLogsum()
    {
        return nmDcLogsum;
    }

    public int getNumPredrivingKidsGoOut()
    {
        return hh.getNumberOfPreDrivingWithNonHomeActivity();
    }

    public int getNumPreschoolKidsGoOut()
    {
        return hh.getNumberOfPreschoolWithNonHomeActivity();
    }

    public int getCollegeEducation()
    {
    ...
    {
        return person.getPersonIsHighSchoolGraduate() == 1 ? 0 : 1;
    }

    public int getDetachedHh()
    {
        return hh.getHhBldgsz() == 1 ? 1 : 0;
    }

    public double getWorkAccessibility()
    {
        return workAccessibility;
    }

    public double getSchoolAccessibility()
    {
