...
public class SchoolEscortChildResult implements Serializable {
	...
	private final short adultPnum;

   	public SchoolEscortChildResult( int pid, short dir, short bundle, short escortType, short adultPnum ) {
   		this.pid = pid;
   		this.dir = dir;
   		this.bundle = bundle;
   		this.escortType = escortType;
   		this.adultPnum = adultPnum;
    }
