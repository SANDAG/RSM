...
public class RunModeChoice {
	...
	private static Logger      logger                  = Logger.getLogger(RunModeChoice.class);
     ...
     * @param sampleSeed
     */
	public RunModeChoice(String propertiesFile, int globalIterationNumber, float globalSampleRate, int sampleSeed){
...
//            aggAcc.setJPPFClient(jppfClient);
	...
	public void runHouseholdModels(){
	...
	public static void main(String[] args) {
	    ...
	    RunModeChoice mainObject = new RunModeChoice(  args[0], globalIterationNumber, iterationSampleRate, sampleSeed );
