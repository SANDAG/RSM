        ...
        implements Serializable
{
     ...
     *            Outbound direction
     */
    public VisitorTrip(VisitorTour tour, boolean outbound)
    {
    ...
    /**
     * Create a visitor trip from a tour\stop. Note: trip mode is unknown. Stop
     * period is only known for first, last stop on tour.
     *
     * @param tour
     *            The tour.
     * @param stop
     *            The stop
     */
    public VisitorTrip(VisitorTour tour, VisitorStop stop, boolean toStop)
    {
