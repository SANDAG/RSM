...
/**
 * This class is the TOD choice model for visitor tours. It is currently based
 * on a static probability distribution stored in an input file, and indexed
 * into by purpose.
 *
 * @author Freedman
 *
 */
public class VisitorStopTimeOfDayChoiceModel
{
    ...
    public VisitorStopTimeOfDayChoiceModel(HashMap<String, String> rbMap)
    {
        ...
        String outboundDurationFile = Util.getStringValueFromPropertyMap(rbMap,
                "visitor.stop.outbound.duration.file");
        String inboundDurationFile = Util.getStringValueFromPropertyMap(rbMap,
                "visitor.stop.inbound.duration.file");
     ...
     * @param stop
     */
    public void chooseTOD(VisitorTour tour, VisitorStop stop)
    {
        ...
        } else
        {
            ...
            if (stop.getId() == 0)
            {
                ...
                {
                    VisitorStop[] outboundStops = tour.getOutboundStops();
