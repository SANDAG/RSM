...
public final class SandagSamplePopulationGenerator
{
    ...
    private static Logger      logger                       = Logger.getLogger(SandagSamplePopulationGenerator.class);
     ...
     * @param baseName
     *            , String containing basename (without .properites) from which
    ...
    private void generateSampleFiles()
    {
        ...
        // have the household data manager read the synthetic population files
        // and
