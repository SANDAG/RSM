...
public class SandagDestChoiceSoaTwoStageModelDMU
        extends DestChoiceTwoStageModelDMU
{

    public SandagDestChoiceSoaTwoStageModelDMU(ModelStructure modelStructure)
    {
    ...
    {
        modeChoiceLogsums[sampleIndex] = logsum;
    }
