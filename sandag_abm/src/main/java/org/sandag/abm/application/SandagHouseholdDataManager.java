        ...
        extends HouseholdDataManager
{
    ...
    public void mapTablesToHouseholdObjects()
    {
        ...
        for (int r = 1; r <= personTable.getRowCount(); r++)
        {
            ...
            try
            {
                ...
                else if (grade == 5) person.setPersonIsHighSchool(true);
                fieldCount++;
            ...
            } catch (Exception e)
            {
                ...
                logger.fatal("exception caught mapping person data record to a Person object, "
                        + String.format(
                                "r=%d, i=%d, hhid=%d, persid=%d, persnum=%d, fieldCount=%d.", r, i,
                                hhid, persId, persNum, fieldCount));
                throw new RuntimeException(e);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println(String.format(
                "SandagHouseholdDataManager server class started on: %s:%d", serverAddress,
                serverPort));
