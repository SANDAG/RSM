...
public class SandagBikePathChoiceDmu
        implements VariableTable, Serializable
{
    ...
    public double getValueForIndex(int variableIndex, int arrayIndex)
    {
        ...
        {
            case 0:
                return getSizeAlt(arrayIndex);
            case 1:
                return getDistanceAlt(arrayIndex);
            case 2:
                return getDistanceClass1Alt(arrayIndex);
            case 3:
                return getDistanceClass2Alt(arrayIndex);
            case 4:
                return getDistanceClass3Alt(arrayIndex);
            case 5:
                return getDistanceArtNoLaneAlt(arrayIndex);
            case 6:
                return getDistanceCycleTrackAlt(arrayIndex);
            case 7:
                return getDistanceBikeBlvdAlt(arrayIndex);
            case 8:
                return getDistanceWrongWayAlt(arrayIndex);
            case 9:
                return getGainAlt(arrayIndex);
            case 10:
                return getTurnsAlt(arrayIndex);
            case 11:
                return getFemale();
            case 12:
                return getInbound();
            ...
            case 14:
                return getSignalsAlt(arrayIndex);
            case 15:
                return getUnsigLeftFromMajorArtAlt(arrayIndex);
            case 16:
                return getUnsigLeftFromMinorArtAlt(arrayIndex);
            case 17:
                return getUnsigCrossMajorArtAlt(arrayIndex);
            case 18:
