...
public class CrossBorderTrip
{
     ...
     *            The stop
     */
    public CrossBorderTrip(CrossBorderTour tour, CrossBorderStop stop, boolean toStop)
    {
     ...
     * @param toStop
     */
    public void initializeFromStop(CrossBorderTour tour, CrossBorderStop stop, boolean toStop)
    {
