...
public class TableDataSetCrosstabber {
    ...
    public static void main(String args[]) {
        if (args.length!=5) {
            System.out.println("usage: java org.sandag.cvm.common.datafile.TableDataSetCrosstabber directory table rows columns, values");
            System.exit(1);
        }
        CSVFileReader myReader= new CSVFileReader();
        myReader.setMyDirectory(args[0]);
