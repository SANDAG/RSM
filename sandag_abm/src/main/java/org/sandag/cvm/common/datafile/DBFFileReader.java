...
import org.sandag.cvm.common.datafile.TableDataFileReader;
import org.sandag.cvm.common.datafile.TableDataSet;

import static org.sandag.cvm.common.datafile.DataTypes.*;
...
public class DBFFileReader extends TableDataFileReader {
    ...
    /**
     * @see org.sandag.cvm.common.datafile.TableDataFileReader#readFile(java.io.File)
     */
    @Override
    ...
    public TableDataSet readTable(String tableName) throws IOException {
        File fileName = new File (getMyDirectory() + File.separator + tableName + ".dbf");
