...
public class CSVFileWriter extends TableDataFileWriter implements DataTypes {
            ...
            for (int r=0; r < nRows; r++) {
                ...
                for (int c=0; c < nCols; c++) {
                    ...
                    case NUMBER:
                        ...
                        if (Float.isInfinite(f[r])) {
                        	// don't want the infinity figure (sideways 8) in output file, want Infinity or -Infinity.
                        	outStream.print(f[r]);
                        } else {
    ...
    /* (non-Javadoc)
     * @see org.sandag.cvm.common.datafile.TableDataWriter#writeTable(org.sandag.cvm.common.datafile.TableDataSet, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.sandag.cvm.common.datafile.TableDataWriter#close()
     */
    public void close() {
    }
